namespace WebApplication1.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw客戶關聯資料表Repository Getvw客戶關聯資料表Repository()
		{
			var repository = new vw客戶關聯資料表Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw客戶關聯資料表Repository Getvw客戶關聯資料表Repository(IUnitOfWork unitOfWork)
		{
			var repository = new vw客戶關聯資料表Repository();
